 ...
 */
public class CategoriesFragment extends Fragment implements com.example.hackit20.NotesAdapter.OnRecyclerItemClick {

    private RecyclerView recyclerView;
    private com.example.hackit20.NotesAdapter notesAdapter;
    private List<com.example.hackit20.NotesModel> modelList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (int i = 0; i < head.length; i++) {
            com.example.hackit20.NotesModel notesModel = new com.example.hackit20.NotesModel();
        ...
        notesAdapter = new com.example.hackit20.NotesAdapter(modelList, getContext());
